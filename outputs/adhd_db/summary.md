...
Sea $N$ el número de sujetos, $C$ el número de canales, $T_s$ la longitud temporal del sujeto $s$, $T$ una longitud temporal común, $T'$ la longitud temporal después del pooling del modelo y $L = 2$ el número de clases.
...
pero para calcular la pérdida temporal se expanden a lo largo de la dimensión temporal:
...
solo cuando todos los sujetos tienen la misma longitud temporal y, por tanto, el mismo $T'$.
