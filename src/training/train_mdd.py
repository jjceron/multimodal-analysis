...
from src.datasets.mdd_db import MDDDataset, create_dataloaders
...
def inspect_dataset(dataset: MDDDataset) -> None:
    labels = []
    shapes = []
...
def main():
    ...
    if args.save_dir is None:
        ...
        args.save_dir = f"mdd_db/eegnet_{args.condition.lower()}_{args.pp_as}_{agg_name}_{args.norm}"
    ...
    print(f"target: H/control=0 vs MDD=1")
    ...
    print(
        f"\nDataset: condition={args.condition} | "
